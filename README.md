...
The library provides a Firmata server enabling the robot to be controlled via thirdparty packages on a host computer.  The server and has been fully tested with [Snap4Arduino](https://snap4arduino.rocks/) client and the availble Python [client package](https://pypi.org/project/codeepy/).